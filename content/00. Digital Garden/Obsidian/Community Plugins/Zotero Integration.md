...
## Zotero Link
### zotero 6
mac: https://www.zotero.org/download/client/dl?channel=release&platform=mac&version=6.0.37
windows: https://www.zotero.org/download/client/dl?channel=release&platform=win32&version=6.0.36

### template
https://github.com/nocona71/obsidian-literature-note
https://github.com/nocona71/obsidian-literature-note/blob/main/templates/literature-note.md
https://github.com/nocona71/obsidian-literature-note/blob/main/snippets/callout-styling.css

## How to do it
https://www.youtube.com/watch?v=C1nuZ2sJa9E&t=1918s
...
{%- macro printTags(rawTags) -%}
	{%- if rawTags.length > 0 -%}
		{%- for tag in rawTags -%}
			### zotero tags: {{ tag.tag | lower | replace(" ","_") }} {{ ' ' }} 
		{%- endfor %}
	{%- endif %}
{%- endmacro -%}
